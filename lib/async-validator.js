...
(function() {
  var ArrayValidator, BooleanValidator, NumberValidator, ObjectValidator, ScalarValidator, StringValidator, ValidationError, Validator, asyncValidator, previousAsyncValidator, regexValidaor, _ref, _ref1, _ref2, _ref3,
    _this = this,
  ...
  asyncValidator.NumberValidator = NumberValidator = (function(_super) {
    ...
    NumberValidator.prototype._validate = function(strOrNumber, cb) {
      ...
      return NumberValidator.__super__._validate.call(this, strOrNumber, function(err, str) {
        if (err) {
          return typeof cb === "function" ? cb(err) : void 0;
        } else {
  ...
  asyncValidator.ObjectValidator = ObjectValidator = (function(_super) {
    ...
    ObjectValidator.prototype._validate = function(obj, cb) {
      var checkComplete, completes, count, errorOccured, errors, idx, innerValidator, k, key, keys, pushKey, v, validatorMap, _i, _j, _len, _len1, _next, _ref4, _results,
        _this = this;
      completes = {};
      errors = {};
      errorOccured = false;
