...
(function() {
  ...
  asyncValidator.ObjectValidator = ObjectValidator = (function(_super) {
    ...
    ObjectValidator.prototype.validate = function(obj, cb) {
      var checkComplete, completes, count, errorOccured, errors, idx, innerValidator, k, key, keys, name, pushKey, v, validator, validatorMap, _i, _j, _len, _len1, _next, _ref4, _results,
        _this = this;
      ...
      for (_j = 0, _len1 = keys.length; _j < _len1; _j++) {
        ...
        if (validator == null) {
          ...
          _results.push(checkComplete());
        } else {
          _results.push(validator.validate(obj[name], function(err, validatedObj) {
            if (err) {
              errorOccured = true;
              errors[name] = err;
            } else {
